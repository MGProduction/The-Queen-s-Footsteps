...
#define string_max_len 466

u8 opcodeattr[50]={130,131,129,129,131,1,1,1,1,129,130,130,130,2,3,2,3,2,2,2,4,2,4,131,129,130,130,130,130,130,130,131,3,131,129,129,130,131,132,131,131,131,131,131,130,129,130,131,129,2};
...
#define op_msgobj 156
#define op_msgroom 157
#define op_msgvar 158
#define op_msgvarattr 159
#define op_needin 160
#define op_put 161
#define op_quit 162
#define op_save 163
#define op_set 164
#define op_setattr 165
#define op_setcount 166
#define op_setobjname 167
#define op_setroomimage 168
#define op_setroomname 169
#define op_setroomoverlayimage 170
#define op_setvar 171
#define op_showobj 172
#define op_start 173
#define op_unset 174
#define op_unsetattr 175
#define op_waitkey 176
#define op_withobj 177
...
u16*imagesidx;
u8*imagesdata;
#define advcartridge_dirsize 76
